/**
 * Selwyn Overnight Care  ·  provider origin `homecare-a`
 *
...
import { HOMECARE_INVENTORY } from '@threshold/test-fixtures';
...
document.documentElement.style.setProperty('--accent', '#6a4a8f');

bootProvider({
  providerId: 'homecare-a',
  displayName: 'Selwyn Overnight Care',
  strapline: "Waking-night and sleep-in care in the person's own home",
  inventory: HOMECARE_INVENTORY,
